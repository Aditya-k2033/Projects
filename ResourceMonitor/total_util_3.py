...
def monitor_resources(interval=1, duration=60):
    ...
    def monitor():
        while time.time() < end_time:
            ...
            cpu_percent_label = tk.Label(root, text="CPU Usage: ")
            cpu_percent_label.pack()
            memory_percent_label = tk.Label(root, text="Memory Usage: ")
            memory_percent_label.pack()
            disk_percent_label = tk.Label(root, text="Disk Usage: ")
    ...
    update_job = root.after(0, monitor)
    root.mainloop()
